...
function Item() {
    return (
        <div className={`w-11/12 h-80 bg-white rounded-md mt-2 hover:border-gray-400 shadow hover:shadow-slate-700 transition-shadow`}>
            ...
            <div className="ml-3">
                <p className="text-sm">Mùa Hè Bất Tận</p>
