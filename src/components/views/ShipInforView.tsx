        ...
        <div className="font-thin text-sm space-y-3 pt-4">
            ...
            <div className="font-semibold flex items-center">
                ...
                <a className="flex" href="">
                    ...
                    <FontAwesomeIcon icon={ faGreaterThan } className="text-blue-400 ml-1 pt-1" />
                </a>
            </div>
            <div>
                <SellCard />
